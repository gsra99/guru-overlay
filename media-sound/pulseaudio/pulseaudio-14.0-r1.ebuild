...
EAPI=6
inherit autotools bash-completion-r1 flag-o-matic gnome2-utils linux-info systemd user udev multilib-minimal git-r3

DESCRIPTION="A networked sound server with an advanced plugin system"
HOMEPAGE="https://www.freedesktop.org/wiki/Software/PulseAudio/"
EGIT_REPO_URI="https://gitlab.freedesktop.org/kapiwko/pulseaudio.git"
EGIT_BRANCH="hsphfpd"
