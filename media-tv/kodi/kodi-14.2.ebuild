...
# $Header: /var/cvsroot/gentoo-x86/media-tv/kodi/kodi-14.2.ebuild,v 1.4 2015/03/19 12:48:23 tupone Exp $
...
LICENSE="GPL-2"
SLOT="0"
IUSE="airplay avahi bluetooth bluray caps cec css debug +fishbmc gles \
goom java joystick midi mysql nfs +opengl profile +projectm pulseaudio \
pvr +rsxs rtmp +samba sftp +spectrum test udisks upnp upower +usb vaapi \
