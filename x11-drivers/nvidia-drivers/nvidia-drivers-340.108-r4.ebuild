...
PATCHES=(
	"${FILESDIR}"/0001-fix-5.6-rc1.patch
	"${FILESDIR}"/0002-fix-5.7-rc1.patch
	"${FILESDIR}"/0003-fix-5.7-rc1-reinstate-legacy-support.patch
	"${FILESDIR}"/0004-fix-5.8.patch
	"${FILESDIR}"/0005-fix-5.9.patch
	"${FILESDIR}"/0006-fix-5.10.patch
	"${FILESDIR}"/0007-fix-5.14.patch
	"${FILESDIR}"/0008-fix-5.15.patch
	"${FILESDIR}"/0009-fix-5.16.patch
)
