...
MOZ_LANGPACK_HTTP_URI="https://archive.mozilla.org/pub/${PN}/releases"
EGIT_REPO_URI="https://github.com/mozilla/gecko-dev"
EGIT_CHECKOUT_DIR="${WORKDIR}/firefox-${PV%_*}"
EGIT_BRANCH="esr60"

MOZCONFIG_OPTIONAL_WIFI=1

inherit check-reqs flag-o-matic toolchain-funcs eutils gnome2-utils llvm \
	git-r3 mozconfig-v6.60 pax-utils xdg-utils autotools mozlinguas-v2
