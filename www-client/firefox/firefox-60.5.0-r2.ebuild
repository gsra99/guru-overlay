...
inherit check-reqs flag-o-matic toolchain-funcs eutils gnome2-utils llvm mozconfig-v6.60-r1 pax-utils xdg-utils autotools mozlinguas-v2
...
src_prepare() {
	eapply "${FILESDIR}/widevinecdm-1.4.9.1088.patch"
